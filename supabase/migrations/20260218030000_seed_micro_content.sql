-- Clear existing content for the new 60-day cycle
TRUNCATE public.daily_content CASCADE;

-- Seed 60 Days of Micro-Devotionals
...
(27, 'Cuidado de Deus', 'Se Deus cuida dos passarinhos, Ele cuida muito mais de você.', 'Mateus 6:26', 'Confie a Deus sua maior preocupação agora.', 'Eu sei que cuidas de mim.', 1),
...
(42, 'VerAlém das Aparências', 'O homem vê o exterior, mas Deus olha direto para o coração.', '1 Samuel 16:7', 'Tente ver a alma por trás do comportamento.', 'Ajuda-me a não julgar pelo que vejo.', 1),
