-- ==========================================================
-- CORREÇÃO CIRÚRGICA DE COLUNAS (NÃO APAGA DADOS)
-- Rode este script se você estiver vendo "column does not exist"
-- ==========================================================

-- 1. ADICIONA AS COLUNAS QUE ESTÃO FALTANDO
...
-- 2. GARANTE QUE O CONTEÚDO DOS 60 PASSOS EXISTE
-- (O comando ON CONFLICT garante que não duplique se já existir)
