...
const Prayers = () => {
  ...
  const fetchPrayers = async () => {
    ...
    console.log("[Prayers] Fetching for user:", user.id);
    console.log("[Prayers] Data:", prayerData);
    if (error) console.error("[Prayers] Error:", error);
    ...
    const submitPost = async () => {
      ...
      if (error) {
        ...
        toast({ title: "Oração salva", description: "Sua oração foi registrada no seu diário pessoal." });
        fetchPrayers();
      }
      setSubmitting(false);
    };
