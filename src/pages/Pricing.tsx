...
const Pricing = () => {
    ...
    const plans = [
        ...
        },
        {
            ...
            price: "R$ 39,90",
            period: "por 6 meses",
            description: "Foco e constância na sua caminhada.",
            features: ["Tudo do Mensal", "Melhor custo-benefício", "Materiais extras"],
            link: KIRVANO_OFFER_LINK,
        ...
        },
        {
            ...
            features: ["Tudo do Semestral", "Economize muito", "Mentorias exclusivas"],
            link: KIRVANO_OFFER_LINK,
