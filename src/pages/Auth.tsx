    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-secondary to-warm-brown p-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-3xl font-bold text-foreground">60 Days Closer</h1>
          <p className="mt-1 text-sm text-muted-foreground">Your journey to a deeper relationship with Jesus</p>
        </div>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              {isSignUp ? "Start your 60-day journey today" : "Continue your spiritual journey"}
            </CardDescription>
          </CardHeader>
          <CardContent>
